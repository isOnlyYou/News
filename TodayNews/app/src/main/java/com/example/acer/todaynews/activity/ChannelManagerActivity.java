...
import com.bawei.library.adapter.DragAdapter;
import com.bawei.library.adapter.OtherAdapter;
import com.bawei.library.bean.ChannelItem;
import com.bawei.library.bean.ChannelManage;
import com.bawei.library.db.SQLHelper;
import com.bawei.library.view.DragGrid;
import com.bawei.library.view.OtherGridView;
import com.example.acer.todaynews.R;
import com.example.acer.todaynews.application.MyApplication;
 ...
 */
public class ChannelManagerActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Gson gson = new Gson();
                String toJson = gson.toJson(userChannelList);
    ...
    private void initData() {
        ...
        SQLHelper sqlHelper = MyApplication.getApp().getSQLHelper();
        ChannelManage manage = ChannelManage.getManage(sqlHelper);
